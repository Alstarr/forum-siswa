...
export default function Kritik() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 className="text-lg md:text-xl font-bold">Forum Kritik dan Saran</h2>
        <p className="text-[#FCED75] text-sm font-medium mt-1">Berikan kritik dan saranmu di bawah ya!</p>
      </motion.div>
